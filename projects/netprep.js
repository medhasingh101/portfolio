(function () {
  ...
  window.portfolioProjects.netprep = {
    ...
    color: "#ece6df",
    previewImage: "./assets/netprep-cover.png",
    previewAlt: "NetPrep case study cover with interface previews.",
    previewOuterBackground: "#eaf0f8",
    previewOuterBorder: "rgba(29, 63, 119, 0.14)",
    previewStageBackground: "#ffffff",
    previewStageWidth: "84%",
    previewStageAspect: "16 / 4.15",
    previewStageBorder: "rgba(29, 63, 119, 0.06)",
    previewImageFit: "cover",
    previewImagePosition: "96% 52%",
    previewImagePadding: "0",
    previewImageScale: "1.16",
    full: {
      overview:
      ...
      modules: [
        ...
        {
          type: "embed",
          src: "https://embed.figma.com/proto/GwOtmpIqydAdSDlMLCXvs0/CPSC-344---Conceptual-Model-Prototype?page-id=3%3A379&node-id=3-385&viewport=817%2C303%2C0.06&scaling=scale-down&content-scaling=fixed&starting-point-node-id=3%3A385&embed-host=share",
