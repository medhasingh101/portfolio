      ...
      <section class="stack-sequence" data-stack-sequence>
          <div class="stack-sticky" data-stack-sticky>
            ...
            <div class="content-section content-section-skills stack-panel stack-panel-skills" data-stack-panel="skills">
              <div class="section-header">
                <span class="section-header-index">02</span>
                <span class="section-header-title">Skills</span>
                <span class="skills-canvas-note">hover to explore / drag to rearrange</span>
              </div>
          ...
          ${window.portfolioData.CONTACT_LINKS.map(
            ([label, value, href]) => {
              const icons = {
                ...
                Resume: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14,2 14,8 20,8"/><line x1="12" y1="11" x2="12" y2="17"/><polyline points="9,14 12,17 15,14"/></svg>`,
              };
              return `
              <a href="${escapeHtml(href)}" class="contact-link" data-hover${label === "Resume" ? ' target="_blank" rel="noopener"' : ""}>
                <span class="contact-link-icon">${icons[label] || ""}</span>
